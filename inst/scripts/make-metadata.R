...
meta <- data.frame(
  ...
  SourceUrl = rep("https://zenodo.org/records/18811118", nb),
  SourceVersion = rep("Feb 10 2026", nb),
  Species = rep("Homo sapiens", nb),
  TaxonomyId = rep("", nb),
  Coordinate_1_based = rep(TRUE, nb),
  DataProvider = rep("EDyP-lab", nb),
  Maintainer = rep("Prostar proteomics <prostar-proteomics@cea.fr>", nb),
  RDataClass = rep("MultiAssayExperiment", nb),
  DispatchClass = rep("FilePath",nb),
  Location_Prefix = rep("https://zenodo.org/", nb),
  RDataPath = c(
    "records/18811118/files/Exp1_R25_prot.RData",
    "records/18811118/files/Exp1_R25_pept.RData",
    "records/18811118/files/Exp1_R2_prot.RData",
    "records/18811118/files/Exp1_R2_pept.RData",
    "records/18811118/files/Exp2_R2_prot.RData",
    "records/18811118/files/Exp2_R2_pept.RData",
    "records/18811118/files/Exp2_R10_prot.RData",
    "records/18811118/files/Exp2_R10_pept.RData",
    "records/18811118/files/Exp2_R100_prot.RData",
    "records/18811118/files/Exp2_R100_pept.RData"),
  Tags = "",
  Notes = ""
)
